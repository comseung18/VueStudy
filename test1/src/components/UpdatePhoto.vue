<template>
    <div class="modal">                
        <div class="form" @keyup.esc="cancleEvent">
            ...
            v-model="d_contact.no">
            <div>
                <label>현재 사진</label>
                <img class="thumb" :src="d_contact.photo">
            </div>
            <div>
...
export default defineComponent({
    ...
    methods: {
        ...
        photoSubmit : function(){
            ...
            //eventBus.emit('updatePhoto', this.d_contact.no, file);
        }
    },
});
</script>
